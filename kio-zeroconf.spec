...
Version  : 25.04.0
Release  : 60
URL      : https://download.kde.org/stable/release-service/25.04.0/src/kio-zeroconf-25.04.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/25.04.0/src/kio-zeroconf-25.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.0/src/kio-zeroconf-25.04.0.tar.xz.sig
...
%setup -q -n kio-zeroconf-25.04.0
cd %{_builddir}/kio-zeroconf-25.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744916299
mkdir -p clr-build
pushd clr-build
