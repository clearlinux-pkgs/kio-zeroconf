...
Version  : 24.12.3
Release  : 59
URL      : https://download.kde.org/stable/release-service/24.12.3/src/kio-zeroconf-24.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/kio-zeroconf-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/kio-zeroconf-24.12.3.tar.xz.sig
...
%setup -q -n kio-zeroconf-24.12.3
cd %{_builddir}/kio-zeroconf-24.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742443446
mkdir -p clr-build
pushd clr-build
