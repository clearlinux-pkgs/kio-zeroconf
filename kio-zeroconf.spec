...
Source0  : https://download.kde.org/stable/release-service/24.12.1/src/kio-zeroconf-24.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.1/src/kio-zeroconf-24.12.1.tar.xz.sig
...
%setup -q -n kio-zeroconf-24.12.1
cd %{_builddir}/kio-zeroconf-24.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736491460
mkdir -p clr-build
pushd clr-build
