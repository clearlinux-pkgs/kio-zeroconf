...
Source0  : https://download.kde.org/stable/release-service/24.05.2/src/kio-zeroconf-24.05.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.2/src/kio-zeroconf-24.05.2.tar.xz.sig
...
%setup -q -n kio-zeroconf-24.05.2
cd %{_builddir}/kio-zeroconf-24.05.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720571142
mkdir -p clr-build
pushd clr-build
