...
Version  : 25.04.1
Release  : 61
URL      : https://download.kde.org/stable/release-service/25.04.1/src/kio-zeroconf-25.04.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/25.04.1/src/kio-zeroconf-25.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.1/src/kio-zeroconf-25.04.1.tar.xz.sig
...
%setup -q -n kio-zeroconf-25.04.1
cd %{_builddir}/kio-zeroconf-25.04.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747096149
mkdir -p clr-build
pushd clr-build
