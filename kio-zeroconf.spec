...
Version  : 24.08.2
Release  : 54
URL      : https://download.kde.org/stable/release-service/24.08.2/src/kio-zeroconf-24.08.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.08.2/src/kio-zeroconf-24.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.2/src/kio-zeroconf-24.08.2.tar.xz.sig
...
%setup -q -n kio-zeroconf-24.08.2
cd %{_builddir}/kio-zeroconf-24.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728586919
mkdir -p clr-build
pushd clr-build
