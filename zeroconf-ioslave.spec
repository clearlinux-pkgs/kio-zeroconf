...
Version  : 21.12.1
Release  : 34
URL      : https://download.kde.org/stable/release-service/21.12.1/src/zeroconf-ioslave-21.12.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/21.12.1/src/zeroconf-ioslave-21.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.12.1/src/zeroconf-ioslave-21.12.1.tar.xz.sig
...
%prep
%setup -q -n zeroconf-ioslave-21.12.1
cd %{_builddir}/zeroconf-ioslave-21.12.1
...
cp %{_builddir}/zeroconf-ioslave-21.12.1/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/zeroconf-ioslave/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/zeroconf-ioslave-21.12.1/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/zeroconf-ioslave/a4c60b3fefda228cd7439d3565df043192fef137
pushd clr-build
%make_install
popd
