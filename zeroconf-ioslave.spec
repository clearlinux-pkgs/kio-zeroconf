...
Version  : 20.12.3
Release  : 26
URL      : https://download.kde.org/stable/release-service/20.12.3/src/zeroconf-ioslave-20.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/20.12.3/src/zeroconf-ioslave-20.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.12.3/src/zeroconf-ioslave-20.12.3.tar.xz.sig
...
%prep
%setup -q -n zeroconf-ioslave-20.12.3
cd %{_builddir}/zeroconf-ioslave-20.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618706614
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/zeroconf-ioslave-20.12.3/COPYING %{buildroot}/usr/share/package-licenses/zeroconf-ioslave/3860f7708aae6a8ddfe8483263b2a5f29b83c975
cp %{_builddir}/zeroconf-ioslave-20.12.3/COPYING.DOC %{buildroot}/usr/share/package-licenses/zeroconf-ioslave/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
cp %{_builddir}/zeroconf-ioslave-20.12.3/COPYING.LIB %{buildroot}/usr/share/package-licenses/zeroconf-ioslave/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
