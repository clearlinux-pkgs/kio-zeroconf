...
Source0  : https://download.kde.org/stable/release-service/21.08.3/src/zeroconf-ioslave-21.08.3.tar.xz
...
%prep
%setup -q -n zeroconf-ioslave-21.08.3
cd %{_builddir}/zeroconf-ioslave-21.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636045047
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/zeroconf-ioslave-21.08.3/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/zeroconf-ioslave/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/zeroconf-ioslave-21.08.3/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/zeroconf-ioslave/a4c60b3fefda228cd7439d3565df043192fef137
pushd clr-build
%make_install
popd
